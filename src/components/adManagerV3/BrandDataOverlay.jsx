            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-neutral-900 mb-1">Connect Ad Account</h2>
                    <p className="text-neutral-500 text-sm">Sync existing ad data</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-neutral-900 mb-1">Create New Campaign</h2>
                    <p className="text-neutral-500 text-sm">Start from scratch</p>
                  </div>
                </div>
    ...
    return (
      <div className="absolute inset-0 z-50 bg-white flex items-center justify-center">
        <div className="max-w-2xl w-full px-6 text-center">
          ...
          {/* Content */}
          <div className="mb-6">
            <p className="text-lg text-neutral-700 leading-relaxed mb-2">
          ...
          <div className="flex gap-6 justify-center">
            ...
            <button
              onClick={onViewError}
              className="inline-flex items-center gap-2 text-neutral-600 hover:text-neutral-900 font-medium transition-colors group text-sm"
            >
    ...
    return (
      <div className="absolute inset-0 z-50 bg-white flex items-center justify-center">
        <div className="max-w-2xl w-full px-6 text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-warning-500 to-danger-500 rounded-full blur-3xl opacity-20 animate-pulse"></div>
              <div className="relative bg-gradient-to-br from-warning-500 to-danger-500 p-6 rounded-full shadow-2xl">
          ...
          <div className="mb-4">
            ...
            <div className="w-20 h-0.5 bg-gradient-to-r from-warning-500 to-danger-500 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-warning-50 border border-warning-200 rounded-lg p-4 max-w-md mx-auto">
              <p className="text-sm text-neutral-600 mb-2">
                <span className="font-semibold text-warning-700">If you have active ads:</span> Please click the retry button to fetch data again
              </p>
              <p className="text-sm text-neutral-600">
                <span className="font-semibold text-warning-700">If no active ads:</span> Please publish ads first to view data
              </p>
            </div>
          </div>
