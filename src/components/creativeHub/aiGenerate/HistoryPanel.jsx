...
export default function HistoryPanel({
  ...
  return (
    <aside className="w-[360px] shrink-0 bg-white border border-[#F0F0F0] rounded-[20px] card-shadow overflow-hidden flex flex-col">
      {/* New AI Creative button */}
      <div className="p-4 shrink-0 bg-gray-50/30">
        <button
          onClick={onNewCreativeClick}
          className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl transition-all group bg-white border border-gray-200 text-gray-700 hover:border-primary-400 hover:shadow-sm"
        >
      ...
      <div className="px-5 py-3 flex items-center gap-2 shrink-0">
        ...
        <span className="text-[14px] font-semibold text-gray-700">History</span>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-3 custom-scrollbar">
        ...
        {Object.entries(sortedAndGroupedHistory).map(([date, items]) => (
          <div key={date} className="mb-6 last:mb-0">
            <h3 className="px-2 mb-2 text-[12px] font-medium text-gray-400 tracking-[0.08em] uppercase">
              {date}
            </h3>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isSelected ? 'bg-[#F5F1FF]' : 'hover:bg-gray-50'
                    )}
                  >
        ...
        <div className="mt-4 mb-2 px-2 flex items-center gap-2">
          ...
          <span className="text-[14px] font-semibold text-gray-700">Examples</span>
        </div>
        <div className="space-y-1">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between py-1">
                    <div className="min-w-0">
                      ...
                      <p className="text-[13px] text-gray-500 truncate mt-0.5">{ex.productUrl}</p>
                    </div>
                    <div className="flex items-center gap-1.5 text-[12px] font-medium text-gray-400 mt-1">
