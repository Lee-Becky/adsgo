    ...
    >
      ...
      >
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          <h3 className="text-base font-semibold text-gray-900">Start New AI Creative?</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 px-4 h-9 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-full hover:bg-gray-50 whitespace-nowrap transition-all"
            >
              Keep Editing
            </button>
            <button
