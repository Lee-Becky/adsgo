    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[80vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-border flex items-center justify-between">
          <h2 className="text-lg font-bold text-neutral-900">{title || 'Feedback'}</h2>
          <button
            onClick={onClose}
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-border bg-neutral-50 flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 py-3 rounded-lg font-medium text-neutral-700 bg-white border border-border hover:bg-neutral-50 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 py-3 rounded-lg font-medium text-white bg-danger-600 hover:bg-danger-700 disabled:bg-neutral-300 disabled:cursor-not-allowed transition-colors"
          >
