    ...
    return (
      <div className="absolute inset-0 z-50 bg-white flex items-center justify-center">
        <div className="max-w-2xl w-full px-6 text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-danger-500 rounded-full blur-3xl opacity-20 animate-pulse"></div>
              <div className="relative bg-gradient-to-br from-orange-500 to-danger-500 p-6 rounded-full shadow-2xl">
          ...
          <div className="mb-4">
            ...
            <div className="w-20 h-0.5 bg-gradient-to-r from-orange-500 to-danger-500 mx-auto rounded-full"></div>
          </div>
