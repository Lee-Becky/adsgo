...
const CampaignTable = ({ budgetStatus, onBudgetStatusChange, onCampaignClick, onBudgetReasonClick, onBudgetEditClick, onMoreInsights, autoExecuteRecommendations, onAutoExecuteToggle }) => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case 'approved':
        return <span className="text-[10px] font-bold text-success-600 bg-success-50 px-2 py-0.5 rounded-full">Approved</span>
      case 'auto_applied':
        return <span className="text-[10px] font-bold text-primary bg-primary/10 px-2 py-0.5 rounded-full border border-primary/20">Auto-applied</span>
      case 'rejected':
        return <span className="text-[10px] font-bold text-danger-600 bg-danger-50 px-2 py-0.5 rounded-full">Rejected</span>
      case 'invalid_modified':
        return <span className="text-[10px] font-bold text-orange-600 bg-orange-50 px-2 py-0.5 rounded-full">Invalid (Modified)</span>
      default:
        return null
    }
  }
    ...
    return (
      ...
      >
        <div className="flex items-center gap-1">
          {children}
          <span className={isSorted ? 'text-primary' : 'text-neutral-300'}>{sortIcon}</span>
        </div>
      </th>
    )
  }
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-neutral-900">Auto-apply Recommendations</span>
              </div>
              <button
            ...
            {autoExecuteRecommendations && (
              <span className="text-xs font-medium text-success-700 bg-success-50 px-3 py-1 rounded-full border border-success-200">
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-neutral-50">
            <tr>
              <th className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[60px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Off/On
              </th>
              <th className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[180px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Campaign
              </th>
              <th className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[100px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Daily Budget
              </th>
              <th className="px-2 py-2 text-center text-xs font-bold text-primary min-w-[320px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                <div className="flex flex-col items-center gap-1">
                  <span>Optimize</span>
                  <span className="text-[10px] text-neutral-400">Updated: January 4, 2026, 13:24:56 (UTC-8)</span>
                </div>
              </th>
              <th className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[120px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Locations
              </th>
              <th className="px-2 py-2 text-left text-xs font-bold text-primary min-w-[100px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Conv. goal
              </th>
              <SortableHeader sortKey="spend" className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[90px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Spend
              </SortableHeader>
              <SortableHeader sortKey="impressions" className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[100px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Impressions
              </SortableHeader>
              <SortableHeader sortKey="cpm" className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[70px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                CPM
              </SortableHeader>
              <SortableHeader sortKey="clicks" className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[70px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Clicks
              </SortableHeader>
              <SortableHeader sortKey="cpc" className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[70px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                CPC
              </SortableHeader>
              <SortableHeader sortKey="ctr" className="px-2 py-2 text-left text-xs font-medium text-neutral-600 min-w-[60px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                CTR
              </SortableHeader>
              <SortableHeader sortKey="results" className="px-2 py-2 text-left text-xs font-bold text-primary min-w-[70px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Conversions
              </SortableHeader>
              <SortableHeader sortKey="costPerResult" className="px-2 py-2 text-left text-xs font-bold text-primary min-w-[110px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Cost/conv.
              </SortableHeader>
              <SortableHeader sortKey="resultCvr" className="px-2 py-2 text-left text-xs font-bold text-primary min-w-[70px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Conv. rate
              </SortableHeader>
              <SortableHeader sortKey="resultValue" className="px-2 py-2 text-left text-xs font-bold text-primary min-w-[100px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                Conv. value
              </SortableHeader>
              <SortableHeader sortKey="resultRoas" className="px-2 py-2 text-left text-xs font-bold text-primary min-w-[70px] sticky top-0 bg-neutral-50/90 z-10 shadow-xs">
                ROAS
              </SortableHeader>
            </tr>
          </thead>
            ...
            {sortedCampaigns.map((campaign) => {
              ...
              return (
                <React.Fragment key={campaign.id}>
                  <tr 
                    className={`hover:bg-primary-50/30 transition-colors duration-fast ${!campaign.enabled ? 'opacity-50' : ''}`}
                  >
                    ...
                    <td className="px-2 py-3">
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute bottom-0 right-0 text-neutral-400 hover:text-primary transition-colors"
                              ...
                              {campaign.status !== 'Paused' && status === 'pending' && !autoExecuteRecommendations && (
                                <div className="flex gap-1">
                                  <button
                                    ...
                                    className="text-[10px] bg-white text-neutral-700 border border-neutral-300 px-1.5 py-0.5 rounded hover:bg-neutral-50 transition-colors"
                                  >
                                    Reject
                                  </button>
                                  <button
                  ...
                  {campaign.expanded && campaign.adsets.map((adset) => {
                    const adsetStatus = budgetStatus[adset.id] || 'pending'
                    return (
                      <tr key={adset.id} className="bg-neutral-50 hover:bg-neutral-100">
                        ...
                        <td className="px-2 py-2">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="font-medium text-neutral-700 text-xs">{adset.name}</div>
