        ...
        <div className="absolute right-0 top-0 h-full w-full max-w-5xl bg-white shadow-2xl overflow-y-auto transform transition-transform">
          ...
          <div className={`p-6 ${status !== 'pending' ? 'opacity-50' : ''}`}>
            <div className="space-y-12 pb-32">
                ...
                <div className="bg-neutral-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/10 p-3 rounded-xl border border-white/5">
                      <p className="text-[10px] text-neutral-400 font-black uppercase">Recommended Budget</p>
                      <p className="text-xl font-black text-success-400">¥{campaign.suggestedBudget || campaign.dailyBudget}</p>
                    </div>
                    <div className="bg-white/10 p-3 rounded-xl border border-white/5">
                      <p className="text-[10px] text-neutral-400 font-black uppercase">Expected Improvement</p>
                    ...
                    {opHistory.length > 0 ? opHistory.map((op, i) => (
                      <div key={i} className="bg-neutral-50 border border-neutral-100 rounded-xl p-4 shadow-sm">
                        <div className="flex justify-between items-center mb-3">
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] bg-info-600 text-white px-1.5 py-0.5 rounded font-black">{op.date}</span>
                        ...
                        <div className="grid grid-cols-2 gap-4 divide-x divide-neutral-200">
                          <div>
                            <p className="text-[9px] text-neutral-400 font-bold uppercase mb-1">Avg. 2 Days Before</p>
                          ...
                          <div className="pl-4">
                            <p className="text-[9px] text-neutral-400 font-bold uppercase mb-1">Avg. 2 Days After</p>
                  ...
                  {showRawTable && (
                    <div className="overflow-x-auto">
                      <table className="w-full text-[10px] text-left">
                        <thead className="bg-neutral-50 text-neutral-400 font-bold uppercase border-b border-neutral-100">
                          <tr>
              ...
              <section>
                ...
                <div className="border border-neutral-100 rounded-2xl overflow-hidden bg-white shadow-sm mb-4">
                  <table className="w-full text-xs text-left">
                    <thead className="bg-neutral-50/80 text-neutral-400 font-black uppercase tracking-widest border-b border-neutral-100">
                  ...
                  {[
                    ...
                    <div key={idx} className="bg-neutral-50 border border-neutral-100 rounded-xl p-3 flex flex-col justify-between">
                      <div className="flex justify-between items-start mb-2">
                        <span className="text-[9px] font-black text-neutral-400 uppercase tracking-tighter">{item.label}</span>
              ...
              <section>
                <h4 className="text-sm font-bold text-neutral-800 mb-4 flex items-center gap-2"><Target size={16} className="text-info-500" /> Conversion Funnel Comparison (US • Add-to-cart)</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    <p className="text-[10px] font-black text-neutral-400 text-center">This Campaign Performance</p>
                    {[
                      { l: 'Spend', v: `¥${campFunnel.spend.toFixed(0)}`, w: 'w-full', c: 'bg-info-600' },
            ...
            {status === 'pending' && (
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-lg font-medium text-white bg-info-600 hover:bg-info-700 transition-colors"
                >
                  Approve
                </button>
              </div>
