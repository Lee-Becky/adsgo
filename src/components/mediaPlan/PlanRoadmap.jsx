  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-semibold text-gray-900">The Plan</h3>
            ...
            >
              ...
              <div className={`flex items-center justify-between mb-3 ${textDim}`}>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">{phase.kpiRange}</div>
                  </div>
                </div>
                {status === 'active' && (
              ...
              <div className={`mb-3 ${textDim}`}>
                <div className="flex items-center gap-1 mb-1.5">
                  ...
                  <span className="text-xs font-semibold text-gray-700">AI does</span>
                </div>
              ...
              <div className={`mb-3 ${textDim}`}>
                <div className="flex items-center gap-1 mb-1.5">
                  ...
                  <span className="text-xs font-semibold text-gray-700">You do</span>
                </div>
                <ul className="space-y-1">
              ...
              {/* Expected Outcome */}
              <div className={`pt-3 border-t border-gray-200/60 ${textDim}`}>
