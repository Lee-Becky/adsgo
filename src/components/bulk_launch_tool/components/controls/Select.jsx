...
const Select = ({
  ...
  return (
    <>
      ...
      >
        <span className={`truncate text-left flex-1 ${selected ? 'text-gray-800' : 'text-gray-300'}`}>
      ...
      <Popover
        ...
        className="bg-white rounded-base shadow-xl border border-gray-100 overflow-hidden min-w-[var(--anchor-width,200px)]"
