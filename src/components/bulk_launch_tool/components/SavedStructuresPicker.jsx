  ...
  return (
    <>
      <button
        ...
        className={[
          ...
          count === 0
            ...
            : 'border-gray-200 text-gray-700 bg-white hover:border-primary-500/40 hover:text-primary-600 hover:bg-primary-50/30',
        ].join(' ')}
      ...
      <Popover
        ...
        className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden w-[360px]"
      >
        <div className="px-4 py-2.5 border-b border-gray-100 bg-gray-50/30">
          <p className="text-xs font-semibold text-gray-700">已保存的结构模板</p>
        </div>
        <div className="max-h-[400px] overflow-y-auto custom-scrollbar p-2">
          {items.map(it => (
            <div key={it.id} className="group flex items-start gap-2 p-2.5 rounded-base hover:bg-gray-50 transition-colors">
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <button
                  ...
                  className="text-gray-300 hover:text-rose-500 p-1 rounded-base hover:bg-rose-50 transition-colors"
                  title="删除"
                >
                  <Trash2 size={12} />
                </button>
