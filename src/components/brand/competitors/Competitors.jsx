      ...
      <div className="sticky top-0 z-10 py-3 px-10 pointer-events-none">
        <div className="max-w-[1400px] mx-auto flex justify-end">
          <button 
            ...
            className="pointer-events-auto bg-neutral-900 text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-black transition-all active:scale-95 shadow-lg shadow-neutral-200 flex items-center gap-2"
          >
            <Plus size={16} />
            Add Competitor
          </button>
        ...
        <div className="max-w-[1000px] mx-auto">
          <div className="flex flex-col gap-6">
            {competitors.map((competitor) => (
              <div 
                key={competitor.id}
                className="group relative bg-white border border-neutral-100 rounded-xl p-8 transition-all hover:shadow-xl hover:shadow-primary-500/5 hover:-translate-y-1 flex items-start gap-8"
              >
                <div className="w-24 h-24 shrink-0 rounded-2xl bg-neutral-50 border border-neutral-100 p-1 overflow-hidden shadow-inner flex items-center justify-center">
                  <img 
                    src={competitor.logo} 
                    alt={competitor.name} 
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <a 
                        ...
                        className="p-2 text-neutral-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-all flex items-center gap-2 text-sm font-bold"
                      >
