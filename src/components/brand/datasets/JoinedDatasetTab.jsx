  ...
  return (
    <div className="bg-white rounded-[32px] border border-slate-200 shadow-[0_4px_24px_rgba(0,0,0,0.04)] overflow-hidden">
      <div className="flex flex-col min-h-[500px]">
        {/* Dataset tabs */}
        <div className="flex items-center gap-2 px-8 py-4 border-b border-slate-100 overflow-x-auto">
          {datasets.map(ds => {
        ...
        {selectedDs ? (
            ...
            <div className="flex items-center justify-between px-8 py-3 border-b border-slate-100">
              <div className="flex items-center gap-3">
                ...
                {(() => {
                  ...
                  return mp && (
                    <span className="flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-bold bg-blue-50 text-blue-600 rounded-full">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-slate-400 py-16">
            <GitMerge size={40} className="text-slate-200 mb-4" />
            <p className="text-sm font-bold text-slate-500 mb-1">No attribution dataset</p>
            <p className="text-xs text-slate-400 mb-4">Create a joined dataset to correlate media and attribution data</p>
            <button
              onClick={() => setShowWizard(true)}
