...
import AdDatasetWizard from './AdDatasetWizard'
import { MEDIA_PLATFORMS, mockAdDatasets, mockAdDatasetRows, DIMENSION_FIELDS, METRIC_FIELDS } from './mockData'

const AdDatasetTab = () => {
  const [datasets, setDatasets] = useState(mockAdDatasets)
  ...
  const rows = selectedDs ? (mockAdDatasetRows[selectedDs.id] || []) : []
  ...
  datasets.forEach(ds => {
    platformCounts[ds.platform] = (platformCounts[ds.platform] || 0) + 1
  })
