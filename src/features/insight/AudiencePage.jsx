...
const AUDIENCE_DATA = [
  { segment: 'Prospecting Broad',  spend: 4200, cpa: 18.40, roas: 3.8, conversions: 228 },
  { segment: 'Lookalike US',       spend: 3100, cpa: 22.10, roas: 3.2, conversions: 140 },
  { segment: 'Retargeting Warm',   spend: 2600, cpa: 12.50, roas: 5.1, conversions: 208 },
  { segment: 'Interest-based',     spend: 1800, cpa: 28.70, roas: 2.1, conversions: 63  },
  { segment: 'Custom Audience',    spend: 1100, cpa: 15.90, roas: 4.2, conversions: 69  },
]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-5">
          <h3 className="font-heading text-sm font-semibold text-neutral-900 mb-4">Spend by Segment</h3>
        ...
        <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-3 content-start">
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-4">
            <p className="text-caption text-neutral-500 mb-1">Best CPA</p>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden">
        <div className="px-5 py-4 border-b border-neutral-100 flex items-center justify-between">
          <h3 className="font-heading text-sm font-semibold text-neutral-900">
            Top Audiences by CPA
          </h3>
          <span className="text-caption text-neutral-400">{AUDIENCE_DATA.length} segments</span>
        </div>
          ...
          <table className="w-full text-caption">
            <thead>
              <tr className="bg-neutral-50 border-b border-neutral-100">
                ...
                <th className="text-left px-4 py-3 font-semibold text-neutral-600 whitespace-nowrap">Segment</th>
